...
public static class GenStatic
{
    ...
    public static void AppendFileName(ref string file, string appendage)
    {
        file = file.Replace(Path.GetFileName(file), $"{Path.GetFileNameWithoutExtension(file)}{appendage}{Path.GetExtension(file)}");
    }
